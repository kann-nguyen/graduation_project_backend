...
import artifactWorkflowRoute from "./routes/artifactWorkflow.routes";
import mitigationRoute from "./routes/mitigation";
...
app.use("/mitigation", mitigationRoute);
...
app.use("/artifact-workflow", artifactWorkflowRoute);
export default app;
